            ...
            <div class="row">
                ...
                <div class="card col-md-8">
                    <form>
                        ...
                        <div class="form-group">
                            <label for="effective_date">Effecttive date</label>
                        ...
                        <button @click="addDrdr(drdr,company,reviewer)" type="button" class="hidden-xs btn btn-new btn-wd btn-neutral btn-round float-right" style=" background-image: linear-gradient(rgb(104, 145, 162), rgb(12, 97, 33));">Submit</button>
                    </form>
                </div>
                <div class="col-md-2"></div>
            </div>
