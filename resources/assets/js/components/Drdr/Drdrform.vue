            ...
            <div class="col-md-12">
                <form>
                    <div class="form-group">
                       <select v-model="drdr.type" class="form-control form-control-lg" @change="selectedType()">
                    ...
                    <button @click="addDrdr(drdr,company,reviewer)" type="button" class="btn btn-primary">Submit</button>
                </form>
            </div>
        </div>
    </div>
