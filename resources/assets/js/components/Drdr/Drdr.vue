<template>
    <div>
        <div class="row">
            <div class="col-md-12">
                <button class="btn btn-primary mb-2" @click="addDrdrForm" >Add Drdr</button>
                <div class="card strpied-tabled-with-hover">
                    <div class="card-header ">
                        <h4 class="card-title">Drdr Forms</h4>
                    </div>
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" v-if="roleId.includes(1) || roleId.includes(3)">
                            <a class="nav-link active" id="pending-reviews-tab" data-toggle="tab" @click="selected=1" href="#pending-reviews" role="tab" aria-controls="pending-reviews" aria-selected="true">Pending Reviews</a>
                        </li>
                        <li  class="nav-item" v-if="roleId.includes(1) || roleId.includes(3)">
                            <a class="nav-link" id="reviewed-forms-tab" data-toggle="tab" @click="selected=2" href="#reviewed-forms" role="tab" aria-controls="reviewed-forms" aria-selected="false">Reviewed Forms</a>
                        </li>
                        <li class="nav-item" v-if="roleId.includes(1) || roleId.includes(2)">
                            <a class="nav-link" id="pending-approvals-tab" data-toggle="tab" @click="selected=3"  href="#pending-approvals" role="tab" aria-controls="pending-approvals" aria-selected="false">Pending Approvals</a>
                        </li>
                        <li class="nav-item" v-if="roleId.includes(1) || roleId.includes(2)">
                            <a class="nav-link" id="approved-forms-tab" data-toggle="tab"   @click="selected=4"  href="#approved-forms" role="tab" aria-controls="approved-forms" aria-selected="false">Approved Forms</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="submitted-tab" data-toggle="tab" @click="selected=5" href="#submitted" role="tab" aria-controls="submitted" aria-selected="false">Submitted Forms</a>
                        </li>
                    </ul>
