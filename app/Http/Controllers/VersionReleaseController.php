...
class VersionReleaseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('version_release.index' , ['location' => 'Version Release']);
    }

    //Version release without nav and sidebar
    public function indexLogin()
    {
        return view('version_release.login');
    }
    ...
    public function store(Request $request) {
        $request->validate([
            ...
            'required_without_all' => 'Please input your version changes'
        ]);
    ...
    public function submitFeedback(Request $request) {
        $validator = Validator::make($request->all(), [
            'version_release_id' => 'required',  // No change here
            'email' => 'required_if:authenticated,false|regex:/(.+)@(.+)\.(.+)/i', // Only required if not authenticated
            'password' => 'required_if:authenticated,false',  // Only required if not authenticated
            'feedback' => 'required',  // No change here
            'authenticated' => 'required',  // No change here
        ]);
        ...
        if (!$request->authenticated) {
            ...
            $validator->validate(); // run default validation first
